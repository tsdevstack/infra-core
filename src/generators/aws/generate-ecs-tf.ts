 ...
 * - CloudWatch Log Groups (per service/worker)
 * - Task Definitions (per service and worker)
 ...
 * Workers are always-on (desired_count = 1) because they poll Redis.
 *
